...
public class NoticeEvent implements Validatable {
	...
	public Notice toNotice(LocalDateTime now) {
		return Notice.of(receiverId, noticeType, this.extractParametersAsString(), now);
	}

	private String extractParametersAsString() {
