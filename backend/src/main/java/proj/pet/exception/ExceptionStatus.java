...
public enum ExceptionStatus {
	...
	ALREADY_REPORTED_MEMBER(HttpStatus.CONFLICT, "이미 신고된 멤버입니다."),
	ALREADY_REPORTED_BOARD(HttpStatus.CONFLICT, "이미 신고된 게시물입니다."),
	ALREADY_REPORTED_COMMENT(HttpStatus.CONFLICT, "이미 신고된 댓글입니다."),
