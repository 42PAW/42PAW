...
public class MemberController {
	...
	@GetMapping("/tagging")
	@AuthGuard(level = USER_OR_ADMIN)
	public MemberProfileResponseDto getTaggingMember(
			@UserSession UserSessionDto userSessionDto,
			@RequestParam("name") String name) {
		return memberFacadeService.getTaggingMember(userSessionDto, name);
	}
	...
	public void changeLanguage(
			@UserSession UserSessionDto userSessionDto,
			@Valid @RequestBody MemberLanguageChangeRequestDto memberLanguageChangeRequestDto) {
